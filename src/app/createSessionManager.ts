...
import { isMac } from '../ui/helpers/platform'
...
import { getDecorations, setDecorations } from '../ui/state/decorationsPreference'
import { setActiveProjectPath } from '../ui/state/activeProject'
